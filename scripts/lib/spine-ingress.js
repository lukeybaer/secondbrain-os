...
function hasAmySignal(text) {
  return /#amy\b|hashtag\s+amy/i.test(String(text || ''));
}
  ...
  return createSpineTask(
    {
      ...
      prompt: [
        ...
        'Run the #ppl/contact-enrichment hook, check for #Amy dispatch intent, and create any child dispatch tasks needed.',
  ...
  return createSpineTask(
    {
      ...
      prompt: [
        ...
        'Run #ppl/contact-enrichment, check for #Amy or spoken "hashtag Amy" dispatch intent, and create any child dispatch tasks needed.',
        'If inspection finds no follow-up, contact fact, dispatch, or other required action, mark this task removed_non_actionable with the reason.',
        '',
        `Title: ${title}`,
  ...
  return createSpineTask(
    {
      ...
      prompt: [
        ...
        'Run the #ppl/contact-enrichment hook and check for #Amy dispatch intent.',
