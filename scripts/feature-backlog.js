...
// the last 24h of rejections. Luke: "the opinion is strong because it is
// real". Algorithm now:
//
...
// Quality gate (2026-05-17 Luke dispatch: "Feature backlog proposals are
...
function createFeature(backlog, { id, title, description, category, initialScore, strategicImpact, summaryOneSentence, detailTwoParagraph, problemStatement, evidence, implementationPlan }) {
  const today = todayStamp();
