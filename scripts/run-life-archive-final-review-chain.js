...
const REQUIREMENTS = `
ExampleCo's requirement is a whole-life AWS-first archive and intelligence system, not a component patch.
...
- Voice identity: consent-aware voice enrollment, diarization, speaker evidence, ExampleCo-first enrollment, no non-ExampleCo enrollment without explicit consent, honest not-enrolled/not-available states, PRIVATE_NAME detection by evidence tiers.
...
- Otter/PRIVATE_NAME count failure: literal search undercounts; heuristic-only search risks false positives. Need evidence-tier counts.
...
This is NOT a component inquiry. Produce a complete end-to-end plan for all of ExampleCo's archive, voice identity, transcript intelligence, retrieval, health, and smarter memory requirements.
