...
2. RELATIONSHIPS: How they relate to the owner (colleague, vendor, prospect, etc.)
...
Contact directory: C:\Users\USER\.claude\projects\C--Users-USER-secondbrain\memory\contacts\
Contact index: C:\Users\USER\.claude\projects\C--Users-USER-secondbrain\memory\contacts\INDEX.md

Do this AUTOMATICALLY. Do not ask the owner whether to do it.
INSTRUCTIONS
fi
