...
5. CONFIRM to user: what regressed, what you fixed, and what mechanical guard now prevents it from happening again.
...
Settings file: ${SECONDBRAIN_ROOT}\.claude\settings.json
Hooks directory: ${SECONDBRAIN_ROOT}\.claude\hooks\
Test directory: ${SECONDBRAIN_ROOT}\src\main\__tests__\
Memory directory: C:\Users\USER\.claude\projects\C--Users-USER-secondbrain\memory\
INSTRUCTIONS
fi
