...
6. Confirm to user: what was saved, where, and how future sessions will pick it up (2-3 sentences max)

Memory directory: C:\Users\USER\.claude\projects\C--Users-USER-secondbrain\memory\
Index file: C:\Users\USER\.claude\projects\C--Users-USER-secondbrain\memory\MEMORY.md
INSTRUCTIONS
fi
