...
const LOGO = '${SECONDBRAIN_ROOT:-/path/to/secondbrain}/pm-strategies-logo.png';
...
function main() {
  ...
  run(
    [
      ...
      `[f2]drawtext=fontfile='${FONT}':text='the owner':fontsize=40:fontcolor=white:borderw=2:bordercolor=black:x=60:y=h-140:enable='between(t\\,1\\,${FACE_DUR})',`,
  ...
  if (outroDur > 0.5) {
    ...
    run(
      [
        ...
        `[l1]drawtext=fontfile='${FONT}':text='PM Strategies with the owner':fontsize=38:fontcolor=white:x=(w-text_w)/2:y=h/2+30:enable='gte(t\\,0.5)',`,
        `drawtext=fontfile='${FONT_REG}':text='github.com/OWNER/secondbrain-os':fontsize=24:fontcolor=#00FF88:x=(w-text_w)/2:y=h/2+80:enable='gte(t\\,0.8)',`,
