 ...
 * prompt edit, to verify the foundation Luke approved on 2026-05-05 is
...
const ASSISTANT_ID = 'dba21f77-2da6-45b2-9379-1b575634a337';
const EC2_HOST = '98.80.164.16';
const EC2_PORT = 3001;
...
(async () => {
  ...
  // continue_session param (Luke 2026-05-05: "elegant way to keep the context")
