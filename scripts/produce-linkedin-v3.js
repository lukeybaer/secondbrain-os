...
// side camera when the owner looks that way or for variety
...
`;
  ...
  // Copy to Desktop
  const desktop = '${USERPROFILE:-~}/Desktop/SecondBrain_LinkedIn_v3.mp4';
  ...
  const ytDesktop = '${USERPROFILE:-~}/Desktop/SecondBrain_YouTube_v3.mp4';
