 ...
 *
 * 2026-05-25 Luke flagged twice on Otter: the token usage card must show
 ...
 * carries the authoritative subscription burn from OpenAI itself:
 *
...
const OUT_PATH = path.join(REPO, 'data', 'agent', 'codex-token-usage-week.json');
