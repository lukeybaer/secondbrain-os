...
const VCF_PATH = path.join('C:', 'Users', 'user', 'Downloads', 'Zain Abbas and 807 others.vcf');
const OUT_PARSED = path.join('C:', 'Users', 'user', 'secondbrain', 'tmp_vcf_parsed.json');
const OUT_REPORT = path.join('C:', 'Users', 'user', 'secondbrain', 'tmp_vcf_report.json');
