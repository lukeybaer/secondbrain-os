...
type Assignee = "the owner" | "Amy" | "Claude Code";
...
const ASSIGNEES: Assignee[] = ["the owner", "Amy", "Claude Code"];
...
export default function Todos() {
  ...
  const [addAssignee, setAddAssignee] = useState<Assignee>("the owner");
