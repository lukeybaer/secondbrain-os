      ...
      {creating ? (
        <div style={{ ...style.card, borderColor: "#2a1a4a" }}>
          ...
          <textarea
            ...
            rows={8}
            style={style.textarea}
            placeholder={`Write the full instructions for this persona.\n\nExample:\nYou are a polite, professional assistant calling on behalf of the owner. You speak confidently and warmly. You introduce yourself as calling on the owner's behalf. You get to the point quickly but are never rude. If you reach voicemail, leave a brief friendly message and say the owner will follow up.`}
          />
