...
const PII_PATTERNS: Array<{ name: string; regex: RegExp }> = [
  ...
  { name: "Credit Card", regex: /\b(?:4\d{12}(?:\d{3})?|5[1-5]\d{14}|3[47]\d{13}|3(?:0[0-5]|[68]\d)\d{11}|6(?:011|5\d{2})\d{12}|(?:2131|1800|35\d{3})\d{11})\b/ },
  ...
  { name: "Date of Birth", regex: /\b(?:dob|date of birth|born)[\s:]+\d{1,2}[\/\-]\d{1,2}[\/\-]\d{2,4}\b/i },
];
