 ...
 *
 * ExampleCo dispatch: "Where are the tests that make sure key files aren't blowing
...
// by running `wc -c <file>` and adExampleCog both ends if a deliberate change
...
const ENVELOPES: FileEnvelope[] = [
  ...
  },
  {
    ...
    minBytes: 120_000,
    // 460k: the 2026-06-11 ladder build added the codex summarizer rung +
    // laddered self-heal (~3KB); the guard is for 10x blowups, not 1% growth.
    maxBytes: 460_000,
