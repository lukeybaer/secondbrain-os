...
describe('SecondBrain pre-built schemas', () => {
    ...
    const r = validate(
      {
        ...
        assistantId: 'dba21f77-2da6-45b2-9379-1b575634a337',
  ...
  it('vapi initiateCall rejects malformed phone', () => {
    const r = validate(
      { phoneNumber: '903-841-0578', assistantId: 'dba21f77-2da6-45b2-9379-1b575634a337' },
      vapiInitiateCallSchema,
    );
  ...
  it('E164_PATTERN compiles and matches expected forms', () => {
    ...
    expect(re.test('903-841-0578')).toBe(false);
