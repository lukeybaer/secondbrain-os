/**
 * ExampleCo 2026-04-29 #learn dispatch: "you said all green but it wasn't."
 *
 ...
 * in the artifact ExampleCo sees.
 *
...
describe('People-files aggregator filter is symmetric (ExampleCo 2026-04-29 #learn)', () => {
  ...
  // ExampleCo 2026-04-29 dispatch (third pass): "you've started dumping all this
