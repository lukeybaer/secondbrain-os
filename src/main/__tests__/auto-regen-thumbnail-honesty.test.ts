 ...
 *
 * Gap guard for 2026-04-26 incident: ExampleCo rejected 5 videos at 14:07 CT
 ...
 * the SAME mtime as before the rejection. The pipeline lied. ExampleCo saw the
 ...
 *    NOT cycle the video back into ExampleCo's review queue.
 */
