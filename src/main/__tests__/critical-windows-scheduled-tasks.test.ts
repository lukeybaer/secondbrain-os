 ...
 *
 * 2026-05-23 ExampleCo briefing blocker root cause: the token usage collector
...
const REQUIRED_TASKS = [
  ...
  // Daily Jesus-centered research card for the briefing.
  'SecondBrain-KingdomEquipping',
  // Overnight self-heal.
