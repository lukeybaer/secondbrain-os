...
describe('routeDefault', () => {
  it('routes "what did Luke say yesterday" to an Otter tool', () => {
    const result = routeDefault('what did Luke say yesterday in transcripts');
  ...
  it('routes "search Gmail from Bryant" to a Gmail tool', () => {
    const result = routeDefault('search gmail inbox from Bryant');
    expect(result.selected).not.toBeNull();
