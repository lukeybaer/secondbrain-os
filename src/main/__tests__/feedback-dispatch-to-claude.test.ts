 ...
 *
 * Locks the 2026-05-02 Luke feature dispatch: "all feedback should go
...
describe('dispatch-feedback-to-claude -- structure', () => {
  ...
  it('spawns claude with --print + --permission-mode bypassPermissions (autonomous, no prompts to Luke)', () => {
    const src = fs.readFileSync(DISPATCH, 'utf8');
