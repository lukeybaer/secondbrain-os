 ...
 *
 * Locks the 2026-04-30 rejection-driven rubric extension. ExampleCo rejected
...
describe('analyze-audio-edges -- rejection feedback baked into the rubric', () => {
  ...
  it('detects leading silence (ExampleCo: "awkward silence at the beginning")', () => {
  ...
  it('detects trailing truncation (ExampleCo: "cuts off her voice in the middle of the word at the end")', () => {
    const src = fs.readFileSync(TOOL, 'utf8');
