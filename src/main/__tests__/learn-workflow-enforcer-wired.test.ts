/**
 * ExampleCo 2026-04-29 #gap (the meta-#gap): "when I say #learn there is a
...
describe("#learn workflow Stop-hook enforcer (ExampleCo 2026-04-29 #gap)", () => {
  ...
  it("enforcer rejects 5/6 responses (the exact pattern that slipped ExampleCo 2026-05-23)", () => {
