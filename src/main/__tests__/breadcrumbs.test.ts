...
describe('extractBreadcrumbs', () => {
  ...
  it('extracts breadcrumb with "the most important thing" signal', () => {
    const transcript =
      ...
      'Alright, thanks the owner. Bye.\n' +
      'The most important thing that happened in that meeting with Evgeny is we made a lasting connection. ' +
      'He and ContactG are really close friends and he wants to come to the farm and meet partner.';
  ...
  it('extracts breadcrumb with "between X and Y" signal', () => {
    const transcript =
      'Okay bye bye.\n' +
      'The conversation between the owner and Evgeny is about building AI agents ' +
  ...
  it('extracts breadcrumb with "note to self" signal', () => {
    const transcript =
      ...
      'and I should loop in ContactG to make it a three person mastermind session.';
    const result = extractBreadcrumbs(transcript);
    expect(result).not.toBeNull();
  ...
  it('handles real-world Evgeny transcript pattern', () => {
    const transcript =
      'Okay, awesome, the owner, thank you for your time. I really enjoyed chatting with you.\n' +
      'Bye. The most important thing that happened in that meeting\n' +
      'with Evgeny, between the owner and Evgeny\n' +
      'is we made a lasting, long term connection. He and ContactG are really close friends, ' +
