 ...
 *
 * Only ExampleCo-initiated answers, interactive approvals, PII/security,
 * video-ready, and voice follow-up may reach ExampleCo. Everything else
...
describe('isNotifyCategoryAllowed', () => {
  ...
  it('the allowlist is exactly six entries', () => {
