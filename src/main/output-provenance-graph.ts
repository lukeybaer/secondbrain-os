...
// links, upstream sibling outputs. When ExampleCo asks "why did Amy say X?"
...
// concrete capabilities ExampleCo has asked for:
//
...
//     -- per-run tree where each output node ExampleCos the set of inputs
