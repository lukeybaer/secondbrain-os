// approval-inbox.ts
//
// Declarative approval workflow. Foreground code that wants ExampleCo's sign-off on a
...
// dashboard / Telegram surfaces pending requests; ExampleCo approves or rejects;
...
// decisions so ExampleCo can see what was approved/rejected at a glance.
