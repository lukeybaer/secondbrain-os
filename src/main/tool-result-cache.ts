...
//     during a call ("what is Luke's wife's name?"). Same tool call, same
...
export type CacheableFn = (args: unknown, result: unknown) => boolean;
...
export class ToolResultCache {
   ...
   */
  get<T = unknown>(toolName: string, args: unknown): T | undefined {
   ...
   */
  set<T>(toolName: string, args: unknown, result: T, ttlMs?: number): boolean {
