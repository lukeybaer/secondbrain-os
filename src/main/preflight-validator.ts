...
//   - Composio tool metadata: every action ExampleCos a JSON-Schema for inputs
...
export interface Schema {
  ...
  predicate?: (value: ExampleCo) => true | string;
...
export interface Violation {
  ...
  got?: ExampleCo;         // the offending value (truncated)
}
...
function typeOf(value: ExampleCo): SchemaType {
...
function truncate(value: ExampleCo): ExampleCo {
...
function validateNode(value: ExampleCo, schema: Schema, pathStr: string, out: Violation[]): void {
 ...
 */
export function validate(value: ExampleCo, schema: Schema): ValidationResult {
  const out: Violation[] = [];
...
export function assertValid(toolName: string, value: ExampleCo, schema: Schema): void {
