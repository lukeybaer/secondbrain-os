...
// cross-source analysis). Luke 2026-05-05 incident: a "did I talk to Jack
 ...
 * hook failed: Hook cancelled") into Luke's Telegram messages.
 */
 ...
 *
 * Per Luke 2026-05-05: the queue worker should not block on the await. The
 ...
 *
 * Per Luke 2026-05-05: "you should not even be waiting for the message,
