...
def style_split_red(img, draw, headline, subline):
    ...
    _centered_text(draw, '@channel1', H - 90, fw, (200,200,200), shadow=False)
...
def style_glow_neon(img, draw, headline, subline):
    ...
    _centered_text(draw, '@channel1', H-85, fw, (0, 180, 200), shadow=False)
...
def style_classified(img, draw, headline, subline):
    ...
    # Watermark
    fw = _font(FONT_REG, 36)
    _centered_text(draw, '@channel1', H-80, fw, (180,180,180), shadow=False)
...
def style_gold_money(img, draw, headline, subline):
    ...
    # Watermark
    fw = _font(FONT_REG, 36)
    _centered_text(draw, '@channel1', H-85, fw, (180,160,80), shadow=False)
...
def style_minimal_bold(img, draw, headline, subline):
    ...
    _centered_text(draw, '@channel1', H-85, fw2, (120,120,120), shadow=False)
...
def make_thumbnail_v2(out_path: Path, headline: str, subline: str,
    ...
    if fn:
        ...
        for line in _wrap_lines(subline, 22):
            ...
            y += 70
        _centered_text(draw, '@channel1', H-80, fw, (150,150,180), shadow=False)
