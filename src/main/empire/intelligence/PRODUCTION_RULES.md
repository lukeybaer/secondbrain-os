...
- Watermark → @channel1 always (in add_watermark_filter)
...
- Calibration: render → owner review → if too loud, apply `volume=0.6` to final output
...
- `@channel1` watermark: bottom-right, fontsize=32, white@0.5, always on
...
- channel: Channel2WithownerBaer (UCw-XcdSwe_kLYNzQ2JT3mDg)
...
- Channel1: cinematic photorealistic, dramatic lighting, glowing tech elements
- Channel2: soft dreamy painterly, warm magical lighting, whimsical/enchanting
