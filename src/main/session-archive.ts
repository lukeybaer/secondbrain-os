...
// conversations with the owner are visible as "here's what you asked
// about this topic before."
//
// Closes the owner's 2026-04-11 concern: "you were so confused about our
...
function sanitizeFtsQuery(query: string): string {
  ...
  // to OR so Amy surfaces approximate matches when the owner's phrasing
