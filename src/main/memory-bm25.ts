...
const STOPWORDS = new Set([
  ...
  'this','that','these','those','it','its','as','if','so','than','then',
  'i','my','me','we','our','you','your','he','his','she','her','they','their',
]);
...
export class MemoryBM25Index {
  ...
  private bestExcerpt(
    ...
    const raw   = lines.slice(start, end + 1).join(' ').trim();
  ...
  get indexedAt(): Date | null { return this.builtAt; }
}
