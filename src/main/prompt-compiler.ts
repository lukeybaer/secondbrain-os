...
export interface TrainExample<I = unknown, O = unknown> {
...
export interface CompiledDemo<I = unknown, O = unknown> {
  input: I;
  output: O;
  score: number;
}

export interface CompiledPrompt<I = unknown, O = unknown> {
  prompt_key: string;
  compiled_at: string;
  base_prompt: string;
...
export interface CompileOptions<I = unknown, O = unknown> {
