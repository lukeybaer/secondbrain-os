...
function getDefaultTodos(): Todo[] {
  const seed: Todo = {
    ...
    assignee: "Amy",
    tags: ["infrastructure"],
    notes: "Decide: port 903-841-0578 to Twilio (Amy owns main number, the owner gets private SIM) vs get separate Twilio number for Amy. Also discuss SMS history import options.",
