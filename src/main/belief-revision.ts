// belief-revision.ts
//
// Active in-flight belief tracker. Amy ExampleCos explicit beliefs through a
...
// stop and ask ExampleCo." That substrate is what this module provides.
//
 ...
 * ExampleCo instead of acting on it. Default criteria:
 *
